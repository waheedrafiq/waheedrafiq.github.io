...
USAGE
  find_obj.py <AphaT1.jpg> <AphaT2.jpg>
  ('C:\\blindximages\\flower1.jpg')
'''
 ...
 #   if len(sys.argv) < 3:
  #      print "No filenames specified"
   #     print "USAGE: find_obj.py <image1> <image2>"
    ...
    #fn1= sys.argv['C:\\blindximages\\flower1.jpg']
    #fn2= sys.argv['C:\\blindximages\\flower2.jpg']

    img1 = cv2.imread('C:\\blindximages\\flower1.jpg')
    img2 = cv2.imread('C:\\blindximages\\flower2.jpg')
