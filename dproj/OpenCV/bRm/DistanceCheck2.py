...
def find_marker(image):
  ...
  #  _,contours,hierarchy= cv2.findContours(edged.copy(),cv2.RETR_LIST,cv2.CHAIN_APPROX_SIMPLE)
   # derp,contours,hierarchy = cv2.findContours(edged.copy(),cv2.RETR_LIST ,cv2.CHAIN_APPROX_SIMPLE)
...
IMAGE_PATHS = ["C:\\blindximages\\Waheed.jpg", "C:\\blindximages\\waheed2.jpg","C:\\blindximages\\group1.jpg"]
