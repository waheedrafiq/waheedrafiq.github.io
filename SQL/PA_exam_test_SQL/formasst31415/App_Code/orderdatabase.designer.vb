...
Partial Public Class menuitem
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_itemimage", DbType:="VarBinary(MAX)", CanBeNull:=true, UpdateCheck:=UpdateCheck.Never)>  _
...
Partial Public Class restaurant
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_restimage", DbType:="VarBinary(MAX)", CanBeNull:=true, UpdateCheck:=UpdateCheck.Never)>  _
